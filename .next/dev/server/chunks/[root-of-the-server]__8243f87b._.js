...
async function handler(req, res) {
    ...
    try {
        ...
        const { files } = parsed;
        const file = files.photo || files.file; // según tu input
        if (!file) return res.status(400).json({
            error: "No se subió archivo"
        });
        // formidable puede devolver array o objeto
        ...
        const newPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(uploadDir, fileName);
        await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].promises.rename(oldPath, newPath);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8243f87b._.js.map