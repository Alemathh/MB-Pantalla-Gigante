...
"[project]/pages/api/list-uploads.js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function handler(req, res) {
    ...
    try {
        ...
        const images = files.filter((file)=>/\.(jpe?g|png|gif|webp|mp4)$/i.test(file)) // agregué mp4 si querés mostrar videos también
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f3e223d3._.js.map