...
async function POST(req) {
    return new Promise((resolve)=>{
        ...
        form.parse(req, (err, fields, files)=>{
            ...
            if (!file) {
                return resolve(Response.json({
                    error: "No vino archivo"
                }, {
                    status: 400
                }));
            }
            const fileName = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].basename(file.filepath);
            const finalPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(uploadDir, fileName);
            __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].renameSync(file.filepath, finalPath);
            return resolve(Response.json({
                success: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ece5dbc1._.js.map