...
"[project]/app/api/list-uploads/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const files = __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].readdirSync(uploadDir).filter((file)=>/\.(jpg|jpeg|png|gif|webp)$/i.test(file)).map((file)=>`/uploads/${folder ? folder + "/" : ""}${file}`);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__32e7a243._.js.map